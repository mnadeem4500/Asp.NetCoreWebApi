...
namespace ExtremeClassified.WebApi.Utils
{
    public class AvPasswordHasher
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="AvPasswordHasher"/>.
        /// </summary>
        /// <param name="optionsAccessor">The options for this instance.</param>
        public AvPasswordHasher(IOptions<PasswordHasherOptions> optionsAccessor = null)
        {
